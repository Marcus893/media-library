...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mail->addAddress('diofj@gmail.com', 'idsfj iodjf');
...
<div class="section page">
    <div class="wrapper">
        ...
        <?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
            echo "<p>Thank you kldfjlks</p>";

        } else { ?>
        <p>idofjiosifojsdiofjsdiofsisfj</p>
        <form method="post" action="suggest.php">
            ...
            <tr style="display:none">
                ...
                <td><input type="text" id="address" name="address" />Please leave it blank</td>
            </tr>
            </table>
